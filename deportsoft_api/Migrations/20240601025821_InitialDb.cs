...
namespace deportsoft_api.Migrations
{
    /// <inheritdoc />
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deportsists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Deportsists_Rutinas_RutinaId",
                        column: x => x.RutinaId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "d61189f9-48b6-4ed7-adc0-e2f444f33e86", null, "client", "client" },
                    { "dcc6fa85-b47d-43cf-b3d9-352ec4a132ff", null, "admin", "admin" }
                });
